;===================================================================
	...
	BITS 16
	%DEFINE MARKOS_VER '1.0.0'	 ;OS version number
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '----- Welcome to MARKOS -----', 0
	os_version_msg		db 'Version ', MARKOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', MARKOS_VER, 0

	dialog_string_1		db 'Welcome to MARKOS Operating System', 0
